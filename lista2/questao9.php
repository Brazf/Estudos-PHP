...
temperatura e a pressão. Sabendo-se que em temperatura inferior a 0° celsius a água encontrase no estado solido. Já quando a temperatura se encontra entre 0° e 100° celsius, a água
...
<?php
    ...
    if($temp < 0){
        echo "água encontrase no estado solido.";
    }
    elseif ($temp >= 0 and $temp <= 100) {
        echo "água encontra-se no estado líquido.";
    }
    else{
        echo "água encontra-se no estado gasoso.";
    }
?>